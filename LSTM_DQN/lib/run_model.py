...
import torch
from LSTM_DQN.lib import environ, models, Backtest
import re
...
class Record_Orders():
    ...
    def main_count(self):
        ...
        env = environ.StocksEnv(prices, bars_count=self.BARS, reset_on_close=False ,random_ofs_on_reset=False)
        net = models.DQNLSTM(env.observation_space.shape[1],hidden_size = 64,num_layers=3, actions_n= env.action_space.n)
